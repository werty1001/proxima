<template>
  <ProximaIcon>
    <svg viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="currentColor">
      <path stroke-width="1.75" d="m1.5 8.5 4 4 9-9" />
    </svg>
  </ProximaIcon>
</template>
...
export const componentName = 'ProximaIconCheck';

/**
 * [Live Demo](https://proxima.wiki/icon) | [Code on Github](https://github.com/werty1001/proxima/blob/main/src/icon/check.vue)
 *
 * ```html
 * <ProximaIconCheck size="xl" />
 * ```
 *
