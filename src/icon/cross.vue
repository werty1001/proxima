<template>
  <ProximaIcon>
    <svg viewBox="0 0 16 16" width="16" height="16" fill="none" stroke="currentColor">
      <path stroke-width="1.75" d="M13 13 3 3m10 0L3 13" />
    </svg>
  </ProximaIcon>
</template>

<script setup lang="ts">
import ProximaIcon from '@/icon/icon.vue';
</script>

<script lang="ts">
import { defineComponent } from 'vue';

export const componentName = 'ProximaIconCross';

/**
 * [Live Demo](https://proxima.wiki/icon) | [Code on Github](https://github.com/werty1001/proxima/blob/main/src/icon/cross.vue)
 *
 * ```html
 * <ProximaIconCross size="xl" />
 * ```
 *
